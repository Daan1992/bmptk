...
RTOS::task * RTOS::rtos_current_task = 0;

// timer list head
RTOS::callback * RTOS::timerList = 0;

// list of tasks, highest prority first
RTOS::task * RTOS::taskList = 0;
...
RTOS::clock * RTOS::clocks = 0;
RTOS::mutex * RTOS::mutexes = 0;
RTOS::channel_base * RTOS::channels = 0;
RTOS::mailbox_base * RTOS::mailboxes = 0;
RTOS::pool_base * RTOS::pools = 0;
