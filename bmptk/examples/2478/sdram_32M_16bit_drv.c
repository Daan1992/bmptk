...
void SDRAM_Init (void)
{
  ...
  EMCDYNAMICCFG0 = 0x0000680;        // 13 row, 9 - col, SDRAM, 16bit bus
  ...
  volatile unsigned long Dummy = *(volatile unsigned short *) ((Int32U)&SDRAM_BASE_ADDR + (0x33UL << (12)));
  // Burst 4, Sequential, CAS-3
  //volatile unsigned long Dummy = *(volatile unsigned short *) ((Int32U)&SDRAM_BASE_ADDR + (0x32UL << (13)));
