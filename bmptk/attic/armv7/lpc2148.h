...
//===========================================================================
//
// This header file was generated by the MakeHeader.py tool version 1.00.
// Please report any errors, omissions, etc. to the author: wouter@voti.nl.
//
...
//   claim that you wrote the original file (or the tool that created it). 
//
//   2. Altered source versions must be plainly marked as such, and must 
//   not be misrepresented as being the original file.
//
...
#define VICVectCntl00_offset     0x00000200
#define VICVectCntl01_offset     0x00000204
#define VICVectCntl02_offset     0x00000208
#define VICVectCntl03_offset     0x0000020c
#define VICVectCntl04_offset     0x00000210
#define VICVectCntl05_offset     0x00000214
#define VICVectCntl06_offset     0x00000218
#define VICVectCntl07_offset     0x0000021c
#define VICVectCntl08_offset     0x00000220
#define VICVectCntl09_offset     0x00000224
#define VICVectCntl010_offset    0x00000228
#define VICVectCntl011_offset    0x0000022c
#define VICVectCntl012_offset    0x00000230
#define VICVectCntl013_offset    0x00000234
#define VICVectCntl014_offset    0x00000238
#define VICVectCntl015_offset    0x0000023c
...
#define VICVectCntl00            0xfffff200
#define VICVectCntl01            0xfffff204
#define VICVectCntl02            0xfffff208
#define VICVectCntl03            0xfffff20c
#define VICVectCntl04            0xfffff210
#define VICVectCntl05            0xfffff214
#define VICVectCntl06            0xfffff218
#define VICVectCntl07            0xfffff21c
#define VICVectCntl08            0xfffff220
#define VICVectCntl09            0xfffff224
#define VICVectCntl010           0xfffff228
#define VICVectCntl011           0xfffff22c
#define VICVectCntl012           0xfffff230
#define VICVectCntl013           0xfffff234
#define VICVectCntl014           0xfffff238
#define VICVectCntl015           0xfffff23c
...
typedef struct {
   ...
   unsigned int VectCntl00;
    unsigned int VectCntl01;
    unsigned int VectCntl02;
    unsigned int VectCntl03;
    unsigned int VectCntl04;
    unsigned int VectCntl05;
    unsigned int VectCntl06;
    unsigned int VectCntl07;
    unsigned int VectCntl08;
    unsigned int VectCntl09;
    unsigned int VectCntl010;
    unsigned int VectCntl011;
    unsigned int VectCntl012;
    unsigned int VectCntl013;
    unsigned int VectCntl014;
    unsigned int VectCntl015;
 } VIC_struct;
...
#define VICVectCntl00        (*(volatile unsigned int *)(0xfffff200))
#define VICVectCntl01        (*(volatile unsigned int *)(0xfffff204))
#define VICVectCntl02        (*(volatile unsigned int *)(0xfffff208))
#define VICVectCntl03        (*(volatile unsigned int *)(0xfffff20c))
#define VICVectCntl04        (*(volatile unsigned int *)(0xfffff210))
#define VICVectCntl05        (*(volatile unsigned int *)(0xfffff214))
#define VICVectCntl06        (*(volatile unsigned int *)(0xfffff218))
#define VICVectCntl07        (*(volatile unsigned int *)(0xfffff21c))
#define VICVectCntl08        (*(volatile unsigned int *)(0xfffff220))
#define VICVectCntl09        (*(volatile unsigned int *)(0xfffff224))
#define VICVectCntl010       (*(volatile unsigned int *)(0xfffff228))
#define VICVectCntl011       (*(volatile unsigned int *)(0xfffff22c))
#define VICVectCntl012       (*(volatile unsigned int *)(0xfffff230))
#define VICVectCntl013       (*(volatile unsigned int *)(0xfffff234))
#define VICVectCntl014       (*(volatile unsigned int *)(0xfffff238))
#define VICVectCntl015       (*(volatile unsigned int *)(0xfffff23c))
...
// no C++ specific section implemented yet

#endif //#ifndef __cplusplus

#endif //#ifdef _H_LPC2148_
