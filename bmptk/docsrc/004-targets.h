...
A bmptk project must be built for a specific target.
The following targets are supported:

   - \ref target-windows "Windows"
   - \ref target-nds "Nintendo DS"
   - \ref target-hu-lpc2148-armboard "HU LPC2148 Armboard"

To use a target, you must install the toolchain (compiler, linker, etc) 
that is appropriate for the target.


-----------------------------------------------------------------------------
\anchor target-windows
## Windows

\image html win-lines.gif

The windows target is used to create a windows executable.
...
The target must be specified in the projects makfile:
\code
TARGET = windows
\endcode
...
\anchor target-lpc1114
## LPC1114


-----------------------------------------------------------------------------

\anchor target-hu-lpc2148-armboard
